insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(1,'Costco Inc.',now(),now(),2.5 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(2,'Walmart Stores Inc.',now(),now(),2 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(3,'Metro Inc.',now(),now(),2.6 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(4,'Canadian Tire Corporation',now(),now(),0.9 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(5,'Empire Company Ltd.',now(),now(),3 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(6,'McKesson Corporation',now(),now(),5.0 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(7,'Lowe’s',now(),now(),2.7 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(8,'The Home Depot, Inc.',now(),now(),2 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(9,'Home Hardware Stores Limited',now(),now(),1.5 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(10,'Shoppers Drug Mart',now(),now(),1.8 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(11,'Rexall Drug Store',now(),now(),4.6 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(12,'London Drugs',now(),now(),5 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(13,'Sobeys',now(),now(),0.7 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(14,'T & T Supermarket',now(),now(),5 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(15,'Loblaws',now(),now(),1.7 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(16,'McDonald’s',now(),now(),5 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(17,'Best Buy',now(),now(),3 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(18,'Starbucks Corp.',now(),now(),3.1 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(19,'Nordstrom',now(),now(),0.2 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(20,'A&W',now(),now(),3.8 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(21,'Staples',now(),now(),0.2 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(22,'Tim Hortons',now(),now(),1.7 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(23,'Pizza Pizza',now(),now(),1.8 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(24,'Apple Store',now(),now(),4.1 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(25,'The Keg',now(),now(),3 ,0);
insert into seller(id,name,created_at,updated_at,remark_score,disabled_flag) values(26,'Second Cup',now(),now(),2.8 ,0);


INSERT INTO `category` VALUES ('1', '2019-06-10 15:33:37', '2019-06-10 15:33:37', 'restaurant', '/static/image/firstpage/restaurant.png', '99'),
('2', '2019-06-10 15:34:34', '2019-06-10 15:34:34', 'hotel', '/static/image/firstpage/hotel.png', '98'),
('3', '2019-06-10 15:36:36', '2019-06-10 15:36:36', 'entertainment', '/static/image/firstpage/entertainment.png', '97'),
('4', '2019-06-10 15:37:09', '2019-06-10 15:37:09', 'grocery', '/static/image/firstpage/grocery.png', '96'),
('5', '2019-06-10 15:37:31', '2019-06-10 15:37:31', 'treatment', '/static/image/firstpage/treatment.png', '96'),
('6', '2019-06-10 15:37:49', '2019-06-10 15:37:49', 'clothing', '/static/image/firstpage/clothing.png', '95'),
('7', '2019-06-10 15:38:14', '2019-06-10 15:38:14', 'drug', '/static/image/firstpage/drug.png', '94'),
('8', '2019-06-10 15:38:35', '2019-06-10 15:38:35', 'book', '/static/image/firstpage/book.png', '93');
...
values(1,'A&W #4878 OSHAWA CENTR',now(),now(),4.9,15,-74.562373,43.89381,1,'Fresh Fast','10:00','22:00','419 KING ST W APT 2',1,'/static/image/shopcover/xchg.jpg');
